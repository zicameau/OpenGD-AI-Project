...
public:
    ...
    /**
     * @brief Adds a new object to the level
     * @param obj Pointer to the object to add
     * @throws std::out_of_range If section calculation fails
     * @throws std::bad_alloc If memory allocation for new section fails
     */
